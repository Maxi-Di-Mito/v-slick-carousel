...
import { defineComponent as Le, computed as D, renderSlot as oe, normalizeProps as ce, mergeProps as fe, createElementVNode as pe, normalizeClass as ve, toDisplayString as ze, openBlock as _, createElementBlock as A, normalizeStyle as Pe, Fragment as Z, renderList as J, createBlock as ie, resolveDynamicComponent as Me, useSlots as Ct, ref as U, getCurrentInstance as It, watch as de, onMounted as Et, onUpdated as Ot, onBeforeUnmount as Mt, withCtx as _e, guardReactiveProps as Ne, createCommentVNode as De, createVNode as _t } from "vue";
var T = /* @__PURE__ */ ((e) => (e.play = "play", e.playing = "playing", e.paused = "paused", e.hovered = "hovered", e.focused = "focused", e.update = "update", e.leave = "leave", e.blur = "blur", e))(T || {}), at = /* @__PURE__ */ ((e) => (e.ondemand = "ondemand", e.progressive = "progressive", e))(at || {}), V = /* @__PURE__ */ ((e) => (e.left = "left", e.right = "right", e.up = "up", e.down = "down", e.vertical = "vertical", e))(V || {}), P = /* @__PURE__ */ ((e) => (e.next = "next", e.previous = "previous", e))(P || {}), re = /* @__PURE__ */ ((e) => (e.auto = "auto", e.manual = "manual", e))(re || {});
...
const Dt = (e, r, o) => {
  var t;
  return (t = e.target) != null && t.tagName.match("TEXTAREA|INPUT|SELECT") || !r ? "" : e.key === "ArrowLeft" ? o ? P.next : P.previous : e.key === "ArrowRight" ? o ? P.previous : P.next : "";
}, zt = (e, r) => {
  let o;
  const {
    centerMode: t,
  ...
  if (r.message === P.previous)
    ...
    if (o = r.index || 0, o === g)
      return null;
    if (y) {
      let m = Pt({ ...e, targetSlideGroupIndex: o });
      o > g && m === "left" ? o = o - n : o < g && m === "right" && (o = o + n);
    }
  } else if (r.message === "index" && (o = Number(r.index), o === g))
    return null;
  return o;
}, Pt = (e) => e.targetSlideGroupIndex > e.currentSlideGroupIndex ? e.targetSlideGroupIndex > e.currentSlideGroupIndex + Wt(e) ? "left" : "right" : e.targetSlideGroupIndex < e.currentSlideGroupIndex - At(e) ? "right" : "left", Wt = ({
  groupsToShow: e,
  centerMode: r,
  rtl: o,
  centerPadding: t
...
function he(e) {
  ...
  if (s ? (H = -$(e), n % y !== 0 && o + y > n && (H = -(o > n ? g - (o - n) : n % y)), u && (H += Math.floor(g / 2))) : (n % y !== 0 && o + y > n && (H = g - n % y), u && (H = Math.floor(g / 2))), w = H * parseInt(`${k}`), j = H * parseInt(`${m}`), c ? f = o * parseInt(`${m}`) * -1 + j : f = o * parseInt(`${k}`) * -1 + w, x) {
    ...
    if (I = t && B[z], f = I ? I.offsetLeft * -1 : 0, u) {
      if (z = s ? o + $(e) : o, f = 0, t) {
        I = t.children[z];
        for (let M = 0; M < z; M++)
...
const qt = (e, r) => {
  ...
  return w || (y === 0 && Y === "right" || y + 1 >= Se && Y === "left" || !r.canGoNext && Y === "left") && (K = Math.round(f.swipeLength * k), L === !1 && x && (x(Y), B.edgeDragged = !0)), !m && I && (I(Y), B.swiped = !0), s ? z = M + K * (j / H) * X : g ? z = M - K * X : z = M + K * X, n && (z = M + K * X), B = {
    ...B,
    touchObject: f,
    swipeLeft: z,
    trackStyle: ge(r, z),
...
const be = (e) => {
  const r = {
    ...
    widthDetection: { type: String, default: re.auto }
  };
...
function lr(e, r, o, t, s, u) {
  return e.type === t.SlideNavigation.previous ? oe(e.$slots, "prevArrow", ce(fe({ key: 0 }, t.arrowSlotProps)), () => [
    pe(
      "button",
      {
        type: "button",
  ...
  ], !0) : oe(e.$slots, "nextArrow", ce(fe({ key: 1 }, t.arrowSlotProps)), () => [
    pe(
      "button",
      {
        type: "button",
...
function cr(e, r, o, t, s, u) {
  return _(), A(
    "div",
    {
      ...
      style: Pe([e.trackStyle, e.detectingWidth ? { width: "0 !important" } : {}])
    },
    [
      (_(!0), A(
        Z,
        null,
        J(t.preCloneSlideGroups, (n, g) => (_(), A("div", fe({
          key: n.key,
          tabindex: "-1",
      ...
      (_(!0), A(
        Z,
        null,
        J(t.originalSlideGroups, (n, g) => (_(), A("div", fe({
          key: n.key,
          tabindex: "-1",
      ...
      (_(!0), A(
        Z,
        null,
        J(t.postCloneSlideGroups, (n, g) => (_(), A("div", fe({
          key: n.key,
          tabindex: "-1",
          class: [n.class, "v-slick-slide-group clone"],
          style: n.style,
...
const hr = /* @__PURE__ */ xe(pr, [["render", gr], ["__file", "/Users/maximilianodimito/Documents/PERSONAL/v-slick-carousel/packages/v-slick-carousel/lib/components/VSlickDots.vue"]]), nt = 50, Sr = /* @__PURE__ */ Le({
  ...
  setup(e, { expose: r, emit: o }) {
    ...
    const w = (i, l, S) => {
      ...
      l.sort(
        (S, v) => t.responsiveBehavior === "desktop-first" ? v - S : S - v
      ), l.forEach((S, v) => {
        const p = Zt({
          [i]: `${S}px`
        });
      ...
      g = S, Object.assign(d.value, v), g !== void 0 && le(g);
    }, z = (i) => {
      var v;
      Qt();
      ...
      if (!d.value.dragging || !a.value.touchMove || a.value.unslick)
        return;
      const l = i.target;
      l != null && l.classList.contains("no-swipe") || z(i);
    }, ke = (i) => {
      ...
      if (!b) return;
      const { slidingState: N, afterSlidingState: C } = b;
      s(
        "beforeChange",
        p,
        N.currentSlideGroupIndex
      );
      const R = ((ue = N.lazyLoadedList) == null ? void 0 : ue.filter(
        (te) => d.value.lazyLoadedList.indexOf(te) < 0
      )) || [];
      R.length && s("lazyLoad", R), Object.assign(d.value, N), S && S.goTo(i), C && await new Promise((te) => {
        y = setTimeout(() => {
          const { animating: Tt, ...Lt } = C;
          (a.value.waitForAnimate || d.value.currentSlideGroupIndex === N.currentSlideGroupIndex) && Object.assign(d.value, Lt), L.push(
            setTimeout(() => {
              d.value.animating = Tt || !1;
            })
          ), s("afterChange", N.currentSlideGroupIndex), y = null, te();
        }, v);
      });
    }, me = (i) => {
      var b, N;
      const l = Ft({
        ...
        ...d,
        ...l,
        trackEl: (N = F.value) == null ? void 0 : N.$el,
        slideGroupCount: O.value
      }, v = he(S), p = ge(S, v);
      ...
      !F.value || !F.value.$el || (a.value.widthDetection === re.manual && i.isWindowResize && await Ie(), me(
        i.shouldSetTrackStyle || a.value.widthDetection === re.manual && i.isWindowResize
      ...
      i == null || i.forEach((p) => {
        ...
        if (!p.onclick)
          p.onclick = () => {
            var N;
            (N = p.closest(".v-slick-slide-group")) == null || N.focus();
          };
        else {
          const N = p.onclick.bind(p);
          p.onclick = (C) => {
            var R;
            N(C), (R = p.closest(".v-slick-slide-group")) == null || R.focus();
          };
        }
        if (p.onload)
      ...
      if (a.value.variableWidth) {
        ...
        Ze.value.forEach((C) => {
          ...
          C.forEach((Te) => {
            var te;
            const { width: ue } = ((te = Te.props) == null ? void 0 : te.style) || {};
            ue && (R = Math.max(R, ue));
          }), b.push(R), v.push(R);
        });
        for (let C = 0; C < l; C++)
        ...
        if (a.value.centerMode) {
          ...
          N.left = `calc(${p.map((R) => `-${R}`).join(" + ")} + (100% - ${C}) / 2 )`;
        }
        d.value.trackStyle = N;
      } else {
        const v = l + S + O.value, p = 100 / a.value.groupsToShow * v, b = 100 / v;
        let N = -b * (l + d.value.currentSlideGroupIndex) * p / 100;
        a.value.centerMode && (N += (100 - b * p / 100) / 2), d.value.slideGroupWidth = b + "%", d.value.trackStyle = {
          width: p + "%",
          left: N + "%"
        };
      }
    }, ne = U(), Fe = U(), Ue = U({}), E = U(), F = U(), a = D(() => {
      const i = lt(t);
      let l = { ...$t, ...i };
      if (ne.value) {
        const S = t.responsive.find(
          (v) => v.breakpoint === ne.value
        );
        l = {
          ...l,
      ...
      () => a.value.infinite && (a.value.infiniteLoopOnEdge && O.value >= a.value.groupsToShow || O.value > a.value.groupsToShow) || ee.value > Ge.value + 1
    ...
    ), ee = D(() => a.value.infinite && a.value.infiniteLoopOnEdge && a.value.groupsToScroll === 1 && O.value >= a.value.groupsToShow ? O.value : Math.ceil(
      Math.max(
    ...
    ) + 1), Oe = D(() => Array.from({ length: ee.value }, (i, l) => {
      if (l !== ee.value - 1 || a.value.infinite && (a.value.centerMode || a.value.infiniteLoopOnEdge))
    ...
    de(
      ...
      goTo: le,
      next: () => q({ message: P.next }),
      prev: () => q({ message: P.previous }),
      canGoNext: ae,
      canGoPrev: Ke,
      play: B,
      pause: M,
      ...
      var i;
      window.addEventListener("resize", Ce), a.value.widthDetection === re.manual && await Ie(), me(!0), X(), a.value.autoplay && W(T.update), a.value.lazyLoad === at.progressive && (k = setInterval(Xe, 1e3)), c = new ResizeObserver(() => {
    ...
    const Je = { props: t, emit: s, slots: u, enquire: n, DEBOUNCE_RESIZE_DURATION: nt, get triggerSlideGroupHandler() {
      ...
      h = i;
    }, media: w, clearBreakpoints: f, makeBreakpoints: I, swipeStart: j, swipeEnd: H, swipeMove: z, play: B, pause: M, autoPlay: W, adaptHeight: X, onTrackOver: Se, onTrackLeave: Y, handleClickVSlickList: K, handleChildClickVSlickTrack: pt, handleKeyDownVSlickList: vt, handleMouseDownOrTouchStartVSlickList: gt, handleMouseMoveOrTouchMoveVSlickList: ye, handleMouseUpOrTouchEndVSlickList: ke, handleMouseLeaveOrTouchCancelVSlickList: we, handleMouseEnterOrOverVSlickTrack: ht, handleMouseLeaveVSlickTrack: St, handleOverDots: yt, handleLeaveDots: kt, handleClickDot: wt, handleNextVSlickArrow: mt, handlePrevVSlickArrow: Gt, changeSlideGroup: q, slideGroupHandler: le, updateState: me, resize: Be, onResize: Q, onResizeEventListener: Ce, onSlideGroupFocus: Re, onSlideGroupBlur: je, progressiveLazyLoad: Xe, checkImagesLoad: Ye, detectWidth: Ie, ssrInit: qe, breakpoint: ne, vSlickCarouselRef: Fe, vSlickCarouselStyle: Ue, vSlickListRef: E, vSlickTrackRef: F, settings: a, canGoPrev: Ke, canGoNext: ae, slides: se, state: d, currentSlideGroupIndex: Ee, currentGroupsToShow: Qe, slideGroupCount: O, pageCount: ee, pivotSlideGroupIndices: Oe, currentPage: Ge, rawSlideGroups: Ze, get SlideNavigation() {
      return P;
    }, get WidthDetection() {
      return re;
  ...
  return _(), A(
    ...
    [
      pe("div", {
        ...
        t.settings.arrows && !t.settings.unslick ? (_(), ie(t.VSlickArrow, {
          key: 0,
          ...
          prevArrow: _e((n) => [
            oe(e.$slots, "prevArrow", ce(Ne(n)), void 0, !0)
          ]),
          _: 3
          /* FORWARDED */
        ...
        t.settings.arrows && !t.settings.unslick ? (_(), ie(t.VSlickArrow, {
          ...
          nextArrow: _e((n) => [
            oe(e.$slots, "nextArrow", ce(Ne(n)), void 0, !0)
          ]),
          _: 3
          /* FORWARDED */
        }, 8, ["type", "center-mode", "infinite", "groups-to-show", "slide-group-count", "current-slide-group-index", "disabled"])) : De("v-if", !0)
      ], 8, yr),
      t.settings.dots && !t.settings.unslick ? (_(), ie(t.VSlickDots, {
        key: 0,
        "current-slide-group-index": t.state.currentSlideGroupIndex,
        infinite: t.settings.infinite,
        "slide-group-count": t.slideGroupCount,
        ...
        customPaging: _e((n) => [
          oe(e.$slots, "customPaging", ce(Ne(n)), void 0, !0)
        ]),
        _: 3
        /* FORWARDED */
